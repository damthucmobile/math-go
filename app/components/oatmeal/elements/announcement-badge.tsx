...
import { ChevronIcon } from '@/app/components/oatmeal/icons/chevron-icon'
  ...
  return (
    <Link
      ...
      className={clsx(
        ...
        variant === 'normal' &&
          'bg-mist-950/5 text-mist-950 hover:bg-mist-950/10 dark:bg-white/5 dark:text-white dark:hover:bg-white/10',
        variant === 'overlay' &&
